...
#define gsSPDisplayListSegment(dl) gsDma1p(G_DL_SEGMENT, dl, 0, G_DL_PUSH)
...
#define gsSPBranchListSegment(dl) gsDma1p(G_DL_SEGMENT, dl, 0, G_DL_NOPUSH)
